...
* Home Assistant
  * HACS [Afvalbeheer](../homeassistant/homeassistant_hacs_afvalbeheer) integration or other bin day schedule
  * Add the [custom countdown helper entities](../homeassistant/homeassistant_hacs_afvalbeheer#custom-helper-entities-days-count-down)
  * LED strip entity
* Node-RED
  * Add and setup HA integration in Node-RED [node-red-contrib-home-assistant-websocket](../node-red/node-red_home-assistant#initial-setup)
  * [Node-RED script](#node-red-script) from this page
    ...
    * [Optional] Add a condition to the flow to turn the light off (earlier than at 0:00)
...
I use Node-RED with [Home Assistant integration](../node-red/node-red_home-assistant) to get read and control Home Assistant entities.
