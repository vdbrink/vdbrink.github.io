...
This project is split into different sections, each section is described on its own page, you can read the subjects you like.

* I first created a [mood board](office_mood_board) with example offices and materials that inspires me.
* Then I created a [virtual design with AI](office_virtual_design_with_ai).
* Find the best matching materials for the [room decoration](office_room_decoration).
* Go for the [desk setup hardware](desk_setup_hardware) for my new office.
* And at least add [accessories](office_accessories) for the finishing touch!
