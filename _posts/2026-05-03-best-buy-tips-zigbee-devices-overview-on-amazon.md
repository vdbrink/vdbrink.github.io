...
# Feed: Best Buy Tips Zigbee devices overview on Amazon

<a href="/buy/smart_home_best_buy_tips"><img src="/buy/images_zigbee/zigbee_banner.png" alt="Smart Home Best Buy Tips" width="100%"></a>

Over the past five(+) years I bought and tested many Zigbee sensors and installed them around the house.
They operate 24/7, with this experience I have now my all-time favorite sensors which work flawlessly in my network.

Because I got many times the question of what my favorite sensors are, I bundled them into a single [page](/buy/smart_home_best_buy_tips).
Each highlighted product contains links to different sellers like AliExpress and Amazon.

Amazon has the feature to create a "storefront" where you can create lists with products you can buy on their website.
