...
{% capture n95_global %}[AliExpress](https://s.click.aliexpress.com/e/_c3HomUfP)*{% endcapture %}
...
|:------------------------------|----------------------------------------------------------------------------------------| 
| **Photo**                     | {{ha_green_img}}                                                                       | 
| **Website**                   | [https://www.home-assistant.io/green/](https://www.home-assistant.io/green/)           | 
| **Brand**                     | Nabu Casa                                                                              | 
